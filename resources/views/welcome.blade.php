    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <svg width="50" height="50" fill="#FF0000" viewBox="0 0 20 20">
            ...
            <div class="mt-16">
                <b class="text-center text-gray-500 dark:text-gray-400">
                    Welcome To Recommender Login Or Register To Continue
                </b>
            </div>
        </div>
    </div>
